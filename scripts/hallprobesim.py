...
cfg_geom_cyl_800mm_slice = cfg_geom('cyl',z_steps_DS, r_steps_800mm[1:2], phi_steps_8[1:2], xy_steps = None, bad_calibration = [False, False, False])
...
cfg_params_Mau_DS_800mm = cfg_params(ns = 3, ms = 50, cns = 0, cms=0, Reff = 5000, func_version=4)
...
cfg_params_GA05_DS_800mm = cfg_params(ns = 3, ms = 80, cns = 0, cms=0, Reff = 7000, func_version=1)
