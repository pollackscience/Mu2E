...
if __name__=="__main__":
    ...
    #data_maker6 = DataFileMaker('../Mau10/Standard_Maps/Mu2e_DSMap',use_pickle = True)
    #data_maker7 = DataFileMaker('../Mau10/TS_and_PS_OFF/Mu2e_DSMap',use_pickle = True)
    data_maker8 = DataFileMaker('../Mau10/DS_OFF/Mu2e_DSMap',use_pickle = True)
