...
FitFunctionMaker2::FitFunctionMaker2(string fit_csv):
    ns(-1),ms(-1),Reff(-1),As(),Bs(),Ds()
{
...
vector<double> FitFunctionMaker2::mag_field_function(double a, double b, double z, bool cart=true){
    double r,phi;
...
int main(){
    FitFunctionMaker2* myfitfunc = new FitFunctionMaker2("param_825.csv");
